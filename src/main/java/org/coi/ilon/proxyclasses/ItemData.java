...
@XmlSeeAlso({
    DpData.class,
    UFPTschedulerCalendarRequestData.class,
    UFPTschedulerRealTimeClockRequestData.class,
    UFPTschedulerListSchedulesInvoke.class,
    FbData.class,
    FileSystemData.class,
    TemplateManagerDataInvoke.class,
    LONDeviceStatusDataInvokeResponse.class,
    LONDeviceRepeatingDataInvokeResponse.class,
    LONDevicePowerlineDataInvokeResponse.class,
    LONDeviceProxyDataInvokeResponse.class,
    LONDevicePPNDataInvokeResponse.class
})

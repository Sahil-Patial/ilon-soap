 ...
 * 			
 * 
 * <p>Java class for Item_DataColl complex type.
 * 
 ...
 *         &lt;element name="Item" type="{http://wsdl.echelon.com/web_services_ns/ilon100/v4.0/message/}Item_Data" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Item_DataColl", propOrder = {
    "ucpTfaultCount",
    "fault",
    "item"
})
public class ItemDataColl
    extends EXSelect
{

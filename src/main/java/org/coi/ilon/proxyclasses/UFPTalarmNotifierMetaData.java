 ...
 * 			
 * 
 * <p>Java class for UFPTalarmNotifier_Meta_Data complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="UCPTalarmLog" type="{http://wsdl.echelon.com/web_services_ns/ilon100/v4.0/message/}E_LonString"/&gt;
...
@XmlType(name = "UFPTalarmNotifier_Meta_Data", propOrder = {
    "ucpTalarmLog",
    "ucpTstart",
    "ucpTstop",
...
@XmlSeeAlso({
    UFPTalarmNotifierClearResponse.class
})
public class UFPTalarmNotifierMetaData
    extends FbData
{

    @XmlElement(name = "UCPTalarmLog", required = true)
    protected ELonString ucpTalarmLog;
    ...
    /**
     * Gets the value of the ucpTalarmLog property.
     * 
     * @return
     *     possible object is
     *     {@link ELonString }
     *     
     */
    public ELonString getUCPTalarmLog() {
        return ucpTalarmLog;
    }

    /**
     * Sets the value of the ucpTalarmLog property.
     * 
     * @param value
     *     allowed object is
     *     {@link ELonString }
     *     
     */
    public void setUCPTalarmLog(ELonString value) {
        this.ucpTalarmLog = value;
    }
